...
export default function Footer() {
  ...
  const appId = encodeURIComponent(hostname || 'luxe-store');
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              />
              <span className="font-display text-xl font-bold text-primary">Luxe Store</span>
            </div>
            <p className="text-sm text-muted-foreground max-w-xs">
              Discover premium fashion, exquisite jewelry, and luxury fragrances curated for the discerning shopper.
            </p>
          </div>
