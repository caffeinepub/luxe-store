...
import type { ShippingAddress, PaymentMethod } from '@/backend';
...
const DEFAULT_PAYMENT: PaymentMethod = { __kind__: 'cashOnDelivery', cashOnDelivery: null };
...
export default function Checkout() {
  ...
  if (!identity) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        ...
        <Button onClick={login} className="bg-accent text-accent-foreground hover:bg-gold-600 font-semibold">
          Login to Continue
        </Button>
      </div>
    );
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <p className="text-xs text-accent uppercase tracking-widest mb-1">Secure</p>
        <h1 className="font-serif text-2xl md:text-3xl font-semibold">Checkout</h1>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-card border border-border rounded-lg p-6">
          {step === 0 && (
            <>
              <h3 className="font-serif text-lg font-semibold mb-4">Shipping Address</h3>
          ...
          {step === 2 && (
            <div className="space-y-6">
              <h3 className="font-serif text-lg font-semibold">Review Your Order</h3>
              ...
              <div className="bg-secondary rounded-lg p-4">
                ...
                <p className="text-sm text-muted-foreground">{shippingAddress.name}</p>
              ...
              <div className="bg-secondary rounded-lg p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  {paymentMethod.__kind__ === 'creditCard' && 'Credit / Debit Card'}
                  {paymentMethod.__kind__ === 'wallet' && 'Digital Wallet'}
                  {paymentMethod.__kind__ === 'cashOnDelivery' && 'Cash on Delivery'}
                </p>
              </div>
